/**
 * Script to add Riccardo Trattoria to the database
 *
 * Usage: node scripts/addRiccardoTrattoria.js
 */
...
const restaurantData = {
  name: 'Riccardo Trattoria',
  address: {
    street: '2119 N Clark St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60614',
    country: 'USA',
  ...
  contact: {
    ...
    website: 'https://www.riccardotrattoria.com/'
  }
};

async function addRiccardoTrattoria() {
  console.log('\n========================================');
  console.log('Adding Riccardo Trattoria to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Riccardo Trattoria already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Riccardo Trattoria Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Riccardo Trattoria:', error.message);
    console.error(error);
    process.exit(1);
  }
