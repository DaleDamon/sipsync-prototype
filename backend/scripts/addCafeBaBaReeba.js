// One-off script: add Cafe Ba-Ba-Reeba! to Firestore
// Run: node scripts/addCafeBaBaReeba.js
require('dotenv').config();
const { db } = require('../firebase');

async function addRestaurant() {
  const name = 'Cafe Ba-Ba-Reeba!';
  const address = {
    street: '2024 N Halsted St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60614',
    country: 'USA',
  };
  const latitude = 41.9189763;
  const longitude = -87.6487203;
