// One-off script: add Chicago Chop House to Firestore
// Run: node scripts/addChicagoChophouse.js
require('dotenv').config();
const { db } = require('../firebase');

async function addRestaurant() {
  const name = 'Chicago Chop House';
  const address = {
    street: '60 W Ontario St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60654',
    country: 'USA',
  };
  const latitude = 41.8930;
