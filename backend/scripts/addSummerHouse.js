/**
 * Script to add Summer House Santa Monica (Chicago) to the database
 *
 * Usage: node scripts/addSummerHouse.js
 */
...
async function addSummerHouse() {
  console.log('\n========================================');
  console.log('Adding Summer House Santa Monica to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Summer House Santa Monica already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Summer House Santa Monica Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Summer House Santa Monica:', error.message);
    console.error(error);
    process.exit(1);
  }
