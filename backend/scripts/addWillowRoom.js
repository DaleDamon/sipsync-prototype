/**
 * Script to add The Willow Room to the database
 *
 * Usage: node scripts/addWillowRoom.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (312) 982-2151',
    website: 'https://willowroomchicago.com/'
  }
};

async function addWillowRoom() {
  console.log('\n========================================');
  console.log('Adding The Willow Room to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ The Willow Room already exists in the database');
    ...
    console.log('\n========================================');
    console.log('The Willow Room Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding The Willow Room:', error.message);
    console.error(error);
    process.exit(1);
  }
