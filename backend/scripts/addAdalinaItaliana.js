/**
 * Script to add Adalina Italiana to the database
 *
 * Usage: node scripts/addAdalinaItaliana.js
 */
...
const restaurantData = {
  name: 'Adalina Italiana',
  address: {
    street: '912 N State St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60610',
    country: 'USA',
  ...
  contact: {
    phone: '+1 (312) 820-9000',
    website: 'https://www.adalinachicago.com/'
  }
};

async function addAdalinaItaliana() {
  console.log('\n========================================');
  console.log('Adding Adalina Italiana to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Adalina Italiana already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Adalina Italiana Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Adalina Italiana:', error.message);
    console.error(error);
    process.exit(1);
  }
