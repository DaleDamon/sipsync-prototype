/**
 * Script to add The Bellevue Chicago to the database
 *
 * Usage: node scripts/addTheBellevue.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (312) 888-8900',
    website: 'https://thebellevuechicago.com'
  }
};

async function addTheBellevue() {
  console.log('\n========================================');
  console.log('Adding The Bellevue Chicago to Database');
  console.log('========================================\n');

  try {
    // Check if The Bellevue already exists
    const existingSnapshot = await db.collection('restaurants')
      .where('name', '==', restaurantData.name)
      .get();

    if (!existingSnapshot.empty) {
      console.log('⚠ The Bellevue already exists in the database');
    ...
    console.log('\n========================================');
    console.log('The Bellevue Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding The Bellevue:', error.message);
    console.error(error);
    process.exit(1);
  }
