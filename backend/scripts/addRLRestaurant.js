/**
 * Script to add RL Restaurant to the database
 *
 * Usage: node scripts/addRLRestaurant.js
 */
...
const restaurantData = {
  ...
  contact: {
    ...
    website: 'https://www.rlrestaurant.com/'
  }
};

async function addRLRestaurant() {
  console.log('\n========================================');
  console.log('Adding RL Restaurant to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ RL Restaurant already exists in the database');
    ...
    console.log('\n========================================');
    console.log('RL Restaurant Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding RL Restaurant:', error.message);
    console.error(error);
    process.exit(1);
  }
