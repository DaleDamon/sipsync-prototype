...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (773) 697-9832',
    website: 'https://www.armitagealehouse.com/'
  }
};

async function addArmitageAlehouse() {
  console.log('\n========================================');
  console.log('Adding Armitage Alehouse to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Armitage Alehouse already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Armitage Alehouse Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Armitage Alehouse:', error.message);
    console.error(error);
    process.exit(1);
  }
