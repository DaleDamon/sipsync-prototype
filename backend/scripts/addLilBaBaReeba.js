// One-off script: add Lil' Ba-Ba-Reeba! to Firestore
// Run: node scripts/addLilBaBaReeba.js
require('dotenv').config();
const { db } = require('../firebase');

async function addRestaurant() {
  const name = "Lil' Ba-Ba-Reeba!";
  const address = {
    street: '441 N Clark St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60654',
    country: 'USA',
  };
  const latitude = 41.890426;
  const longitude = -87.630916;
