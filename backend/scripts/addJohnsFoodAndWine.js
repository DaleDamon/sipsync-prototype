/**
 * Script to add John's Food and Wine to the database
 *
 * Usage: node scripts/addJohnsFoodAndWine.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (773) 383-7104',
    website: 'https://www.johnsfoodandwine.com/'
  }
};

async function addJohnsFoodAndWine() {
  console.log('\n========================================');
  console.log("Adding John's Food and Wine to Database");
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log("⚠ John's Food and Wine already exists in the database");
    ...
    console.log('\n========================================');
    console.log("John's Food and Wine Added Successfully!");
    console.log('========================================\n');

  } catch (error) {
    console.error("✗ Error adding John's Food and Wine:", error.message);
    console.error(error);
    process.exit(1);
  }
