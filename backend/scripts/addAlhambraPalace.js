/**
 * Script to add Alhambra Palace to the database
 *
 * Usage: node scripts/addAlhambraPalace.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (312) 666-9555',
    website: 'https://alhambrapalacechicago.com/'
  }
};

async function addAlhambraPalace() {
  console.log('\n========================================');
  console.log('Adding Alhambra Palace to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Alhambra Palace already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Alhambra Palace Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Alhambra Palace:', error.message);
    console.error(error);
    process.exit(1);
  }
