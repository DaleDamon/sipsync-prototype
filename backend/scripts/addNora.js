/**
 * Script to add Nora Chicago to the database
 *
 * Usage: node scripts/addNora.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (312) 801-4446',
    website: 'https://www.norarestaurant.com/'
  }
};

async function addNora() {
  console.log('\n========================================');
  console.log('Adding Nora Chicago to Database');
  console.log('========================================\n');

  try {
    // Check if Nora already exists
    const existingSnapshot = await db.collection('restaurants')
      .where('name', '==', restaurantData.name)
      .get();

    if (!existingSnapshot.empty) {
      console.log('⚠ Nora already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Nora Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Nora:', error.message);
    console.error(error);
    process.exit(1);
  }
