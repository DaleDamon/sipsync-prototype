/**
 * Script to add The Franklin Room to the database
 *
 * Usage: node scripts/addFranklinRoom.js
 */
...
const restaurantData = {
  name: 'The Franklin Room',
  address: {
    street: '675 N Franklin St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60654',
    country: 'USA',
  ...
  contact: {
    phone: '+1 (312) 445-4686',
    website: 'https://www.franklinroom.com/'
  }
};

async function addFranklinRoom() {
  console.log('\n========================================');
  console.log('Adding The Franklin Room to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ The Franklin Room already exists in the database');
    ...
    console.log('\n========================================');
    console.log('The Franklin Room Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding The Franklin Room:', error.message);
    console.error(error);
    process.exit(1);
  }
