/**
 * Script to add Tzuco to the database
 *
 * Usage: node scripts/addTzuco.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (312) 685-3300',
    website: 'https://www.tzuco.com/'
  }
};

async function addTzuco() {
  console.log('\n========================================');
  console.log('Adding Tzuco to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Tzuco already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Tzuco Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Tzuco:', error.message);
    console.error(error);
    process.exit(1);
  }
