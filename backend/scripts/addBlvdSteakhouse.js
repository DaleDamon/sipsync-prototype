/**
 * Script to add BLVD Steakhouse to the database
 *
 * Usage: node scripts/addBlvdSteakhouse.js
 */
...
const restaurantData = {
  name: 'BLVD Steakhouse',
  address: {
    street: '817 W Lake St',
    city: 'Chicago',
    state: 'IL',
    zipCode: '60607',
    country: 'USA',
  ...
  contact: {
    phone: '+1 (312) 526-3116',
    website: 'https://www.blvdchicago.com/'
  }
};

async function addBlvdSteakhouse() {
  console.log('\n========================================');
  console.log('Adding BLVD Steakhouse to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ BLVD Steakhouse already exists in the database');
    ...
    console.log('\n========================================');
    console.log('BLVD Steakhouse Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding BLVD Steakhouse:', error.message);
    console.error(error);
    process.exit(1);
  }
