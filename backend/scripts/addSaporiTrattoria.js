/**
 * Script to add Sapori Trattoria Chicago to the database
 *
 * Usage: node scripts/addSaporiTrattoria.js
 */
...
async function addSaporiTrattoria() {
  console.log('\n========================================');
  console.log('Adding Sapori Trattoria Chicago to Database');
  console.log('========================================\n');

  try {
    // Check if Sapori Trattoria already exists
    const existingSnapshot = await db.collection('restaurants')
      .where('name', '==', restaurantData.name)
      .get();

    if (!existingSnapshot.empty) {
      console.log('⚠ Sapori Trattoria already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Sapori Trattoria Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Sapori Trattoria:', error.message);
    console.error(error);
    process.exit(1);
  }
