/**
 * Script to add Swift Tavern to the database
 *
 * Usage: node scripts/addSwiftTavern.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (773) 360-0207',
    website: 'https://www.swiftandsonstavern.com/'
  }
};

async function addSwiftTavern() {
  console.log('\n========================================');
  console.log('Adding Swift Tavern to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Swift Tavern already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Swift Tavern Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Swift Tavern:', error.message);
    console.error(error);
    process.exit(1);
  }
