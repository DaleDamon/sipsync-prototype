/**
 * Script to add Momotaro Chicago to the database
 *
 * Usage: node scripts/addMomotaro.js
 */
...
async function addMomotaro() {
  console.log('\n========================================');
  console.log('Adding Momotaro Chicago to Database');
  console.log('========================================\n');

  try {
    // Check if Momotaro already exists
    const existingSnapshot = await db.collection('restaurants')
      .where('name', '==', restaurantData.name)
      .get();

    if (!existingSnapshot.empty) {
      console.log('⚠ Momotaro already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Momotaro Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Momotaro:', error.message);
    console.error(error);
    process.exit(1);
  }
