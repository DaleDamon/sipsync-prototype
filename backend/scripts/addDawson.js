/**
 * Script to add The Dawson Chicago to the database
 *
 * Usage: node scripts/addDawson.js
 */
...
const restaurantData = {
  ...
  contact: {
    ...
    website: 'https://the-dawson.com/'
  }
};

async function addDawson() {
  console.log('\n========================================');
  console.log('Adding The Dawson Chicago to Database');
  console.log('========================================\n');

  try {
    // Check if The Dawson already exists
    const existingSnapshot = await db.collection('restaurants')
      .where('name', '==', restaurantData.name)
      .get();

    if (!existingSnapshot.empty) {
      console.log('⚠ The Dawson already exists in the database');
    ...
    console.log('\n========================================');
    console.log('The Dawson Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding The Dawson:', error.message);
    console.error(error);
    process.exit(1);
  }
