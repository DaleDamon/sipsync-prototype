/**
 * Script to add Mordecai to the database
 *
 * Usage: node scripts/addMordecai.js
 */
...
const restaurantData = {
  ...
  contact: {
    phone: '+1 (773) 269-5410',
    website: 'https://www.mordecaichicago.com/'
  }
};

async function addMordecai() {
  console.log('\n========================================');
  console.log('Adding Mordecai to Database');
  console.log('========================================\n');
  ...
  try {
    ...
    if (!existingSnapshot.empty) {
      console.log('⚠ Mordecai already exists in the database');
    ...
    console.log('\n========================================');
    console.log('Mordecai Added Successfully!');
    console.log('========================================\n');

  } catch (error) {
    console.error('✗ Error adding Mordecai:', error.message);
    console.error(error);
    process.exit(1);
  }
